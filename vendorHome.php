...
<head>
    ...
    <?php
      ...
      $sql="SELECT manager from vendors where Username='".$vendor."'";
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="vendorHome.php">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="vendorHome.php">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="vendorHome.php?logout=1" data-toggle="modal" data-target="#logoutModal">
...
<div class='container'>
    <form>
      <label>
        <input class='form-control' name='' value=''></input>
    </form>
</div>
