...
<span class=" "><strong>Thank you for using FreshXpress!</strong></span>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                      ...
                      <div class="col">
                        <button class='btn btn-primary' onclick='show();'>Change Status</button>
                      </div>
                    </div>
                    <hr>
                    <div class='row' id="newAdd" style="display: none;">
                      <form method='get' action='orderDetail1.php?orderID=<?php echo $orderid; ?>'>
                      <select name='status'>
                        <option value='confirmed'>confirmed</option>
                          <option value='canceled'>canceled</option>
                            <option value='finished'>finished</option>
                      </select>
                      <button type='submit' value='submit'>Confirm change</button>
                    </form>
                  </div>
              ...
              <script type="text/javascript">
                function show() { document.getElementById('newAdd').style.display = 'block'; }
                function hide() { document.getElementById('newAdd').style.display = 'none'; }
                function show_card() { document.getElementById('payment').style.display = 'block'; }
                function hide_card() { document.getElementById('payment').style.display = 'none'; }
              </script>
